...
-- La inserarea program?rilor în tabel, costul acestora a fost trecut 0. 
...
-- Angaja?ii centrului de echita?ie au fost în?tiin?a?i printr-un email al unei 
-- firme de resurse c? aceasta ?i-a închis toate depozitele din România. 
-- ?tiind c? email-ul este equipment@equinelife.com, 
-- s? se elimine loca?iile depozitelor închise din baza de date. 
...
-- La programarea din data de 7 aprilie 2022 desf??urat? în intervalul orar 14:00 – 15:00, 
-- angajatul centrului de echita?ie a fost în?tiin?a? de c?tre client c? în ultimul 
-- aviz pe care l-a adus s-a strecurat o gre?eal?: numele medicului era de fapt Zamfir Ionel Mihai. 
-- Modifica?i acest aspect în baza de date. 
...
--Centrul de echitatie se gânde?te s? modifice salariile salariatilor 
...
-- au depozite în judetele în care se afl? ?i cabinetele veterinare în care se g?sesc 
...
-- maro ?i sunt de sex feminin ?i centrele de dresaj care au luna înfiin??rii decembrie. 
-- Cerere:
